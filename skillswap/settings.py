"""
Django settings for Allogami project.
...
# handle media files such as profile pictures
MEDIA_URL = '/media/'
...
# Email configuration
'''
Uses SMTP in production and 
console backend locally
'''
if DEBUG:
    ...
    DEFAULT_FROM_EMAIL = os.environ.get('EMAIL_HOST_EMAIL')
